...
public class EndView {
	...
	//특정 프로젝트 출력 
	public static void projectView(MoneyLifeProject project){
	...
	//모든 프로젝트 출력
	public static void projectListView(ArrayList<MoneyLifeProject> allProbonoProject){
	...
	public static void JSONObject(ArrayList<MoneyLifeProject> allProbonoProject) {
		for(int index = 0; index < allProbonoProject.size(); index++){			
